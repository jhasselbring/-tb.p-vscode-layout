...
function Layout({ layoutConfig = {} }) {
    ...
    return (
        <StyledContainer>
            ...
            <StyledMain>
                {/* Navigation section */}
                <StyledNav style={layoutConfig?.components?.styles?.Nav}>
                ...
                >
                    ...
                    <Panel minSize={1} defaultSize={15}>
                        <LeftDrawer style={layoutConfig?.components?.styles?.LeftDrawer}>
                    ...
                    <Panel minSize={1}>
                        <EditorArea style={layoutConfig?.components?.styles?.Editor}>
                            <PanelGroup direction="vertical">
                                ...
                                <Panel minSize={10}>
                                    <ConsolePanel id="console" className="console-area" style={layoutConfig?.components?.styles?.ConsolePanel}>
                    ...
                    <Panel minSize={1} defaultSize={15}>
                        <RightDrawer style={layoutConfig?.components?.styles?.RightDrawer}>
